        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 mt-3">
                    ...
                    <div class="mt-3">Nowe rekordy: <?php session_start(); if (isset($_SESSION['newRowsNumber'])) echo $_SESSION["newRowsNumber"]; ?>
                        Duplikaty: <?php if (isset($_SESSION['duplicatesNumber'])) echo $_SESSION["duplicatesNumber"]; ?></div>
                </div>
